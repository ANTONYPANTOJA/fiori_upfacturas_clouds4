		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#nsasazappuploadinvoices-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"nsasazappuploadinvoices-display": {
								"semanticObject": "nsasazappuploadinvoices",
								"action": "display",
								"description": "Carga Masiva de Facturas Financieras",
								"title": "Carga Masiva de Facturas",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ns.asa.zappuploadinvoices",
									"url": sap.ui.require.toUrl("ns/asa/zappuploadinvoices")
								}
							}
						}
					}
